...
VALUES 
  (gen_random_uuid(), 'test.user@company.com', crypt('123456', gen_salt('bf')), now(), now(), now(), '{"full_name": "Test User"}'),
  (gen_random_uuid(), 'customs@sudan.com', crypt('123456', gen_salt('bf')), now(), now(), now(), '{"full_name": "Sudan Customs Authority"}')
